...
public:
    CMainParams() {
        ...
        // Burn Addresses
        strIssueAssetBurnAddress = "QTCissueMainAssetxxxxxxxxxxxbGuFVF";
        strReissueAssetBurnAddress = "QTCreissueMainAssetxxxxxxxxxWGEWXQ";
        strIssueSubAssetBurnAddress = "QTCissueSubAssetxxxxxxxxxxxxygYtLx";
        strIssueUniqueAssetBurnAddress = "QTCissueUniqueAssetxxxxxxxxxygpRdo";

        //Global Burn Address
        strGlobalBurnAddress = "QTCcommonBurnAddressxxxxxxxxud6Mwm";
