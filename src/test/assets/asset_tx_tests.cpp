...
BOOST_FIXTURE_TEST_SUITE(asset_tx_tests, BasicTestingSetup)
    ...
    BOOST_AUTO_TEST_CASE(asset_tx_not_valid_test)
    {
        ...
        // This should fail because 900 QTC doesn't have a destination
        CAssetTransfer assetTransfer("QTC", 100);
    ...
    BOOST_AUTO_TEST_CASE(asset_tx_multiple_assets_test)
    {
        ...
        CAssetTransfer asset2("QTCTEST", 1000);
        CScript scriptPubKey2 = GetScriptForDestination(DecodeDestination(Params().GlobalBurnAddress()));
        asset2.ConstructTransaction(scriptPubKey2);

        CAssetTransfer asset3("QTCTESTTEST", 1000);
        ...
        {
            // Add the first asset
            CAssetTransfer outAsset("QTC", 100);
            ...
            CAssetTransfer outAsset2("QTCTEST", 100);
            ...
            // Add the third asset
            CAssetTransfer outAsset3("QTCTESTTEST", 100);
        ...
        // The inputs are spending 3000 Assets (1000 of each QTC, QTCTEST, QTCTESTTEST)
        // The outputs are spending 100 Assets to 10 destinations (10 * 100 = 1000) (of each QTC, QTCTEST, QTCTESTTEST)
