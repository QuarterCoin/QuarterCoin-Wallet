...
/**
  Quartercoin GUI main class. This class represents the main window of the Quartercoin UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class QuartercoinGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit QuartercoinGUI(const PlatformStyle *platformStyle, const NetworkStyle *networkStyle, QWidget *parent = 0);
    ~QuartercoinGUI();
    ...
    */
    ...
    /** Set the wallet model.
        The wallet model represents a quartercoin wallet, and offers access to the list of transactions, address book and sending
        functionality.
    */
