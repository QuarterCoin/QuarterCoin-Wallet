...
#include "qt/quartercoinamountfield.h"
...
uint256 SendCoins(CWallet& wallet, SendCoinsDialog& sendCoinsDialog, const CTxDestination& address, CAmount amount, bool rbf)
{
    ...
    entry->findChild<QuartercoinAmountField*>("payAmount")->setValue(amount);
...
//
//     src/qt/test/test_quartercoin-qt -platform xcb      # Linux
//     src/qt/test/test_quartercoin-qt -platform windows  # Windows
//     src/qt/test/test_quartercoin-qt -platform cocoa    # macOS
void TestGUI()
{
    ...
    QString balanceComparison = QuartercoinUnits::formatWithUnit(unit, balance, false, QuartercoinUnits::separatorAlways);
    ...
    // Amount input
    QuartercoinAmountField* amountInput = receiveCoinsDialog.findChild<QuartercoinAmountField*>("reqAmount");
    ...
    for (QWidget* widget : QApplication::topLevelWidgets()) {
        if (widget->inherits("ReceiveRequestDialog")) {
            ...
            QVERIFY(paymentTextList.at(1).indexOf(QString("URI: quartercoin:")) != -1);
