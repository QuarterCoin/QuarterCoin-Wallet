...
/** Quartercoin unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class QuartercoinUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit QuartercoinUnits(QObject *parent);

    /** Quartercoin units.
      @note Source: https://en.quartercoin.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        QTC,
...
typedef QuartercoinUnits::Unit QuartercoinUnit;
