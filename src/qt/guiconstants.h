...
/* QuartercoinGUI -- Size of icons in status bar */
...
/* Quartercoin label color as a string */
...
#define QAPP_ORG_NAME "Quartercoin"
#define QAPP_ORG_DOMAIN "quartercoin.co"
#define QAPP_APP_NAME_DEFAULT "Quartercoin-Qt"
#define QAPP_APP_NAME_TESTNET "Quartercoin-Qt-testnet"
