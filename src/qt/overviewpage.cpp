...
public:
    explicit TxViewDelegate(const PlatformStyle *_platformStyle, QObject *parent=nullptr):
        QAbstractItemDelegate(parent), unit(QuartercoinUnits::QTC),
...
void OverviewPage::setBalance(const CAmount& balance, const CAmount& unconfirmedBalance, const CAmount& immatureBalance, const CAmount& watchOnlyBalance, const CAmount& watchUnconfBalance, const CAmount& watchImmatureBalance)
{
    ...
    ui->labelBalance->setText(QuartercoinUnits::formatWithUnit(unit, balance, false, QuartercoinUnits::separatorAlways));
    ui->labelUnconfirmed->setText(QuartercoinUnits::formatWithUnit(unit, unconfirmedBalance, false, QuartercoinUnits::separatorAlways));
    ui->labelImmature->setText(QuartercoinUnits::formatWithUnit(unit, immatureBalance, false, QuartercoinUnits::separatorAlways));
    ui->labelTotal->setText(QuartercoinUnits::formatWithUnit(unit, balance + unconfirmedBalance + immatureBalance, false, QuartercoinUnits::separatorAlways));
    ui->labelWatchAvailable->setText(QuartercoinUnits::formatWithUnit(unit, watchOnlyBalance, false, QuartercoinUnits::separatorAlways));
    ui->labelWatchPending->setText(QuartercoinUnits::formatWithUnit(unit, watchUnconfBalance, false, QuartercoinUnits::separatorAlways));
    ui->labelWatchImmature->setText(QuartercoinUnits::formatWithUnit(unit, watchImmatureBalance, false, QuartercoinUnits::separatorAlways));
    ui->labelWatchTotal->setText(QuartercoinUnits::formatWithUnit(unit, watchOnlyBalance + watchUnconfBalance + watchImmatureBalance, false, QuartercoinUnits::separatorAlways));
...
void OverviewPage::showAssets()
{
    if (AreAssetsDeployed()) {
        ...
        // This keeps the QTC balance grid from expanding and looking terrible when asset balance is hidden
