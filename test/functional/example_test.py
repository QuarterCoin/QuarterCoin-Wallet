...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the QuartercoinTestFramework
    pass

class ExampleTest(QuartercoinTestFramework):
    # Each functional test is a subclass of the QuartercoinTestFramework class.
    ...
    def custom_method(self):
        ...
        QuartercoinTestFramework class so other tests can use it."""
