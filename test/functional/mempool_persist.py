...
By default, quartercoind will dump mempool on shutdown and
...
class MempoolPersistTest(QuartercoinTestFramework):
    ...
    def run_test(self):
        ...
        self.start_node(0)
        self.start_node(1)
        # Give quartercoind a second to reload the mempool
        time.sleep(1)
        ...
        self.log.debug("Prevent quartercoind from writing mempool.dat to disk. Verify that `savemempool` fails")
