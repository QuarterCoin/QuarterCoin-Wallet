...
class AssetTest(QuartercoinTestFramework):
    ...
    def activate_assets(self):
        self.log.info("Generating QTC for node[0] and activating assets...")
    ...
    def big_test(self):
        ...
        n0.listassets(asset="QTC*", verbose=False, count=2, start=-2)
        ...
        quartercoin_assets = n0.listassets(asset="QTC*", verbose=False, count=2, start=-2)
        assert_equal(len(quartercoin_assets), 2)
        assert_equal(quartercoin_assets[0], "QTC2")
        assert_equal(quartercoin_assets[1], "QTC3")
        self.sync_all()
