...
# TestNode: A peer we use to send messages to quartercoind, and store responses.
...
class CompactBlocksTest(QuartercoinTestFramework):
    ...
    # This test actually causes quartercoind to (reasonably!) disconnect us, so do this last.
    ...
    # quartercoind's choice of nonce.
    ...
    # Test that quartercoind requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for quartercoind to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # quartercoind will not send blocktxn responses for blocks whose height is
