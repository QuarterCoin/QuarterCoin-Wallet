...
from test_framework.test_framework import QuartercoinTestFramework, SkipTest
...
class ZMQTest (QuartercoinTestFramework):
    ...
    def setup_nodes(self):
        ...
        # Check that quartercoin has been built with ZMQ enabled.
        ...
        if not config["components"].getboolean("ENABLE_ZMQ"):
            raise SkipTest("quartercoind has not been built with zmq enabled.")
