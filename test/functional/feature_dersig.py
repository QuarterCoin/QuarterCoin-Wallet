...
class BIP66Test(QuartercoinTestFramework):
    ...
    def run_test(self):
        ...
        with mininode_lock:
            ...
            # quartercoind is running with multiple script check threads. If script
            # check threads are not in use, then transaction script validation
            # happens sequentially, and quartercoind produces more specific reject
            # reasons.
