...
EXPECTED_HOLDER_NAMES = [
    ...
    "The Quartercoin Core developers\n",
    "The Quartercoin Core developers \n",
    "Quartercoin Core Developers\n",
    "the Quartercoin Core developers\n",
    "The Quartercoin developers\n",
    "BitPay Inc\.\n",
    "BitPay, Inc\.\n",
...
YEAR = "20[0-9][0-9]"
YEAR_RANGE = '(%s)(-%s)?' % (YEAR, YEAR)
HOLDER = 'The Quartercoin Core developers'
...
USAGE = """
copyright_header.py - utilities for managing copyright headers of 'The Quartercoin 
