...
This document provides guidelines for internationalization of the Quartercoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `quartercoin_en.ts` remains unchanged.
